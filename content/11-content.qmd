...
As for all homework assignments, make an R Studio project. Copy-paste [this quarto template for your preregistration](../problem_sets/07-template.qmd){download=true}. The template already includes the relevant sections that you will have to fill out. You'll find more detailed instructions within each section.
