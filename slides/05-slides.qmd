...
## Your turn #1: Calculating an estimate {visibility="hidden"}
...
We don't if the estimate we found in this sample is actually true for the population of **all films**
...
You have seen before the estimated mean differences of our imaginary samples (the $\hat{\delta}s$), somehow magically, forms a curve that is...
...
The central limit theorem states that, with many observations, the sampling distribution approximates a theoretical distribution.
:::
...
Now, all we need to do is bring our sampling distribution on the scale of a normal distribution. 
:::
...
Now we can say for sure that in our Null world, chances that we get an estimate like the one in our IMBD data is **less than 5%**
