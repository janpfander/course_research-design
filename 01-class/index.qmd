...
Read the [guide on `Rprojects`](guides/install.qmd), including the reference to [this short chapter](https://r4ds.hadley.nz/workflow-scripts#projects). 
...
3. Render your document as a PDF file. Use the "Render" menu:

```{r render-button, echo=FALSE, out.width="50%"}
knitr::include_graphics("images//render-button.png", error = FALSE)
```

4. Upload the rendered document in the Homework section of this week on Moodle [add link].
